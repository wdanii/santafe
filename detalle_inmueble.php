    ...
    <section id="carrusel_y_miniaturas">
        <div class="container d-flex flex-wrap">
            ...
            <div class="col-12 col-lg-7 col-xl-7">
                ...
                <div class="d-block d-lg-none d-xl-none col-12 col-lg-5 col-xl-5 caracteristicas_inmueble">
            ...
            <!-- CARACTERISTICAS DEL INMUEBLE -->
            <div class="d-none d-lg-block d-xl-block col-12 col-lg-5 col-xl-5 caracteristicas_inmueble">
                ...
                <div class="d-flex justify-content-between mt-2 flex-wrap">
                    ...
                    <div class="justify-content-lg-center justify-content-xl-center d-flex align-items-center col-6 p-0">
                        <i class="azul mr-2 fas fa-bath"></i>
                        <p class="mr-2"> Baños: </p>
                        <p> <?php echo $banios ?> </p>
                    </div>
                    ...
                    <div class="justify-content-lg-center justify-content-xl-center d-flex align-items-center col-6 p-0 mt-2">
                        <i class="azul mr-2 fas fa-warehouse"></i>
                        <p class="mr-2"> Garajes: </p>
                        <p> <?php echo $garaje ?> </p>
                    </div>
